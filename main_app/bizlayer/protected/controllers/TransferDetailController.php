<?php
class TransferDetailController extends PrivateController {
    public function __construct($arg = NULL) {
        parent::__construct($arg);
        $this->_datagrid_id = 9;
        /*FOR CSV IMPORT -- START*/
        $this->_csv_report_id = 3;
        $this->_model_name = 'TransferDetail';
        $this->_table_id = 9;
        $this->_col_01_fld = 'column_9_01';
        /*FOR CSV IMPORT -- END*/
        $this->_keyword_searchable_fields = array("column_9_01","column_9_02","column_9_03");
    ...
    */
    ...
    private function _getList($return_array=array()) {
        ...
        $transfer_master_id = $request->getParam('entry_id', 0);
        ...
        $forTransferMasterPanel = $request->getParam('forTransferMasterPanel',0);

        // TransferDetails Summary Grid Grouping Direction
        $groupDir = "desc";
        ...
        $orderDetailsModel = TransferDetail::model();
        $alais = "t9";
        ...
        $getWhereConditionParams = array(
            ...
            'transfer_master_id'        => $transfer_master_id,
            'sql_where_rolewise'        => $sql_where_rolewise,
            'forTransferMasterPanel'    => $forTransferMasterPanel
        ...
        $listDataParams = array(
            ...
            // 'forTransferDetailSummary' => $forTransferDetailSummary,
            'groupDir'              => $groupDir,
            'mode'                  => $mode,
