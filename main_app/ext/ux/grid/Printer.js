...
Ext.define("Ext.ux.grid.Printer", {
    ...
    statics: {
         ...
         */
        print: function(title, grid, featureId) {
            ...
            Ext.each(selectedRows, function (item, row) {
                 var convertedData = {};
                //apply renderers from column model
                for (var key in item.raw) {
                    var value = item.raw[key];
                    var found = false;
                    ...
                    Ext.each(columns, function(column, col) {
                        if (column && column.dataIndex == key) {
                            ...
                            if(column.editorxtype == 'timefield') {
                              value = item.data[key];
                            }
                            /*---------[END]-------*/
