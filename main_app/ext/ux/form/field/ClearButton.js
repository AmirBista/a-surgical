(function() {
    ...
    Ext.define('Ext.ux.form.field.ClearButton', {
        ...
        /**
         * @cfg {Boolean} Hide the clear button when the field is Readonly (default: false).
         */
        hideClearButtonWhenReadOnly: false,
        ...
        init: function(textField) {
            ...
            this.textField.addEvents('textCleared');
        ...
        handleMouseClickOnClearButton: function(event, htmlElement, object) {
            ...
            this.textField.fireEvent('textCleared',this.textField);
        },
        ...
        shouldButtonBeVisible: function() {
            ...
            //custom config added by min on 20140828
            //dont show clear button when field is readonly or disabled.
            if (this.hideClearButtonWhenReadOnly && (this.textField.readOnly || this.textField.disabled)){
                return false;
            }
