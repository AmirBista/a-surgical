...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.ux.Carousel": "../../ext/ux/Carousel.js",
  "Ext.ux.Router": "../../ext/ux/Router.js",
  "Ext.ux.SnoColRenderer": "../../ext/ux/SnoColRenderer.js",
  "Ext.ux.form": "../../ext/ux/form",
  ...
  "JRQSVoice": "../../app",
  "YBase.Application": "../../app/application.js",
  "YBase.store.UserStationStore": "../../app/store/userStationStore.js",
  "overrides": "../../overrides"
});
Ext.ClassManager.addNameAlternateMappings({
  ...
  "YBase.Application": [],
  "YBase.component.CheckedTreeCmp": [],
  "YBase.component.FilterCheckBox": [],
  "YBase.component.SupervisorCmp": [],
  "YBase.controller.AppraisalController": [],
  "YBase.controller.AppraisalDetailWinController": [],
  "YBase.controller.CommentController": [],
  "YBase.controller.CommentDetailWinController": [],
  "YBase.controller.CsvImportController": [],
  "YBase.controller.DashboardController": [],
  "YBase.controller.ImageSelectionController": [],
  "YBase.controller.IncidenceController": [],
  "YBase.controller.IncidenceDetailWinController": [],
  "YBase.controller.LoginController": [],
  "YBase.controller.Main": [],
  "YBase.controller.MainController": [],
  "YBase.controller.MeetingMgmtController": [],
  "YBase.controller.MeetingMgmtDetailWinController": [],
  "YBase.controller.NoticeController": [],
  "YBase.controller.NoticeDetailWinController": [],
  "YBase.controller.SettingsController": [],
  "YBase.controller.TreeWinController": [],
  "YBase.model.AppraisalStaffModel": [],
  "YBase.model.ComboItemModel": [],
  "YBase.model.Department": [],
  "YBase.model.FieldOption": [],
  "YBase.model.FieldOptionData": [],
  "YBase.model.FilesModel": [],
  "YBase.model.IncidenceModel": [],
  "YBase.model.MeetingMgmtModel": [],
  "YBase.model.MeetingTreeModel": [],
  "YBase.model.NewsDbModel": [],
  "YBase.model.NewsModel": [],
  "YBase.model.NoticeCategory": [],
  "YBase.model.NoticeModel": [],
  "YBase.model.NoticeType": [],
  "YBase.model.SettingOptionModel": [],
  "YBase.model.TreeItem": [],
  "YBase.model.UserInfoModel": [],
  "YBase.store.AppraisalStaffStore": [],
  "YBase.store.CheckedItemTreeStore": [],
  "YBase.store.CommentFinalFileStore": [],
  "YBase.store.CommentSupervisorFileStore": [],
  "YBase.store.CommentSupportFileStore": [],
  "YBase.store.DepartmentJson": [],
  "YBase.store.DepartmentStore30": [],
  "YBase.store.DepartmentStore70": [],
  "YBase.store.FieldOptionDataJson": [],
  "YBase.store.FieldOptionJson": [],
  "YBase.store.InciFinalFileStore": [],
  "YBase.store.InciSolutionFileStore": [],
  "YBase.store.InciSupervisorFileStore": [],
  "YBase.store.InciSupportFileStore": [],
  "YBase.store.MeetingCategoryTreeStore": [],
  "YBase.store.MeetingFileStore": [],
  "YBase.store.MeetingMgmtListStore": [],
  "YBase.store.MeetingMgmtStore": [],
  "YBase.store.NewsDbStore": [],
  "YBase.store.NoticeCategories": [],
  "YBase.store.NoticeFileStore": [],
  "YBase.store.NoticeListStore": [],
  "YBase.store.NoticeStore": [],
  "YBase.store.NoticeTypeStore": [],
  "YBase.store.PageSizeStore": [],
  "YBase.store.SettingOptionGridStore": [],
  "YBase.store.SettingOptionStore": [],
  "YBase.store.SolutionStatusStore": [],
  "YBase.store.UserBranchStore": [],
  "YBase.store.UserDepartmentStore": [],
  "YBase.store.UserInfoStore": [],
  "YBase.store.UserStationStore": [],
  "YBase.store.UsersStore": [],
  "YBase.utility.ButtonHelper": [],
  "YBase.utility.CsvHelper": [],
  "YBase.utility.DataViewHelper": [],
  "YBase.utility.DateFilterHelper": [],
  "YBase.utility.DefaultValueHelper": [],
  "YBase.utility.GridHelper": [],
  "YBase.utility.LanguageHelper": [],
  "YBase.utility.Mask": [],
  "YBase.utility.PrintHelper": [],
  "YBase.utility.RefinedSearchHelper": [],
  "YBase.utility.ResolutionHelper": [],
  "YBase.utility.Router": [
    "YBase.Router"
  ],
  "YBase.utility.ScreenHelper": [],
  "YBase.utility.SettingOptionHelper": [],
  "YBase.utility.TabLoader": [],
  "YBase.utility.TooltipHelper": [],
  "YBase.utility.UxHelper": [],
  "YBase.utility.WindowHelper": [],
  "YBase.view.Appraisal": [],
  "YBase.view.AppraisalCsvImportWin": [],
  "YBase.view.AppraisalDetailWin": [],
  "YBase.view.CheckTreeWin": [],
  "YBase.view.Comment": [],
  "YBase.view.CommentCsvImportWin": [],
  "YBase.view.CommentDetailWin": [],
  "YBase.view.CsvImportWin": [],
  "YBase.view.CsvUploadWin": [],
  "YBase.view.Dashboard": [],
  "YBase.view.ImagePopup": [],
  "YBase.view.Incidence": [],
  "YBase.view.IncidenceDetailWin": [],
  "YBase.view.Login": [],
  "YBase.view.Main": [],
  "YBase.view.MainPanel": [],
  "YBase.view.MeetingMgmt": [],
  "YBase.view.MeetingMgmtDetailWin": [],
  "YBase.view.NewEditOptionValueWindow": [],
  "YBase.view.Notice": [],
  "YBase.view.NoticeDetailWin": [],
  "YBase.view.NoticeDetailWinTpl": [],
  "YBase.view.SettingConfirmWin": [],
  "YBase.view.SettingOption": [],
  "YBase.view.Settings": [],
  "YBase.view.Viewport": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "YBase.store.InciSupportFileStore": [],
  "YBase.store.MeetingCategoryTreeStore": [
    "store.MeetingCategoryTreeStore"
  ],
  "YBase.store.MeetingFileStore": [],
  "YBase.store.MeetingMgmtListStore": [],
  "YBase.store.MeetingMgmtStore": [],
  ...
  "YBase.view.AppraisalCsvImportWin": [
    "widget.AppraisalCsvImportWin"
  ],
  "YBase.view.AppraisalDetailWin": [
    "widget.AppraisalDetailWin"
  ],
  "YBase.view.CheckTreeWin": [
    "widget.checkTreeWin"
  ],
  ...
  "YBase.view.CommentCsvImportWin": [
    "widget.CommentCsvImportWin"
  ],
  "YBase.view.CommentDetailWin": [
    "widget.CommentDetailWin"
  ],
  "YBase.view.CsvImportWin": [
    "widget.CsvImportWin"
  ],
  ...
  "YBase.view.MeetingMgmtDetailWin": [
    "widget.MeetingMgmtDetailWin"
  ],
  "YBase.view.NewEditOptionValueWindow": [
    "widget.newEditOptionValueWindow"
  ],
  "YBase.view.Notice": [
    "widget.notice"
  ],
  "YBase.view.NoticeDetailWin": [
    "widget.NoticeDetailWin"
  ],
  "YBase.view.NoticeDetailWinTpl": [
    "widget.NoticeDetailWinTpl"
  ],
  "YBase.view.SettingConfirmWin": [
    "widget.SettingConfirmWin"
  ],
  "YBase.view.SettingOption": [
...
Ext.setVersion("jrqsvoice-theme", "1.0.0");
