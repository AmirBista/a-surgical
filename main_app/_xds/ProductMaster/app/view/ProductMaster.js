/*
 * File: app/view/ProductMaster.js
 *
...
Ext.define('YBase.view.ProductMaster', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.productMaster',
                            ...
                            items: [
                                {
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            flex: 1,
                                            hidden: true,
                                            itemId: 'productBatchDetailGrid',
                                            layout: 'fit'
                                        },
                                        {
                                            xtype: 'tabpanel',
                                            flex: 1,
                                            itemId: 'productDetailTabPanel',
                                            activeTab: 0,
                                            items: [
                                                {
                                                    xtype: 'panel',
                                                    itemId: 'productBatchDetail',
                                                    layout: 'fit',
                                                    title: 'Tab 1',
                                                    items: [
                                                        {
                                                            xtype: 'container',
                                                            itemId: 'productBatchDetailGridCnt',
                                                            layout: 'fit'
                                                        }
                                                    ]
                                                },
