...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "JRQSVoice.Application": [],
  "JRQSVoice.controller.Main": [],
  "JRQSVoice.view.Main": [],
  "JRQSVoice.view.Viewport": [],
  "TBase.model.ProductMappedModel": [],
  "TBase.model.ProductSetModel": [],
  "TBase.store.ProductMappedStore": [],
  "TBase.store.ProductSetStore": [],
  "TBase.view.CsvImportWin": [],
  "TBase.view.ProductSet": []
});
