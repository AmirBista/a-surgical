Ext.define('YBase.controller.OrderController', {
    extend: 'YBase.controller.BasicBaseController',
    id: 'OrderController',
    currentViewAlias:'order',
    ...
    languageImplementation: function(absCmp){
        ...
        absCmp.setTitle(orderLang.panelTitle);
         absCmp.query('menuitem[itemId=monthlySalesPrintMenu]')[0].setText(orderLang.monthlySalesPrintMenu);
         absCmp.query('menuitem[itemId=orderContractPrintMenu]')[0].setText(orderLang.orderContractPrintMenu);
         absCmp.query('menuitem[itemId=menuItemServiceInvoice]')[0].setText(orderLang.menuItemServiceInvoice);
        // absCmp.query('button[itemId=btnNewEntry]')[0].setText(orderLang.btnNewEntry);
        // absCmp.query('button[itemId=btnEditPopupEntry]')[0].setText(orderLang.btnEditPopupEntry);
    },
    ...
    loadGrid: function(me, abstractcomponent, templateId, delStatus, setTemplate) {
        ...
        params['order_type'] = Ext.LANG.order.orderType.order;
    ...
    renderOrderMasterGrid: function(me, abstractcomponent,resp){
        ...
        me.gridCnt.gridStore.on('beforeload', function( store, operation, eOpts){
            store.getProxy().extraParams = {'order_type' : Ext.LANG.order.orderType.order};
        });
    ...
    onOrderMasterGridSelectionChange: function(grid, selected, eOpts) {
        var me = this,
            orderPanel  = me.getOrder(),
            orderMasterGrid =  me.absCmp.query('grid[itemId='+me.gridCnt.gridItemId+']')[0];
    ...
    openEntryPanelPopupWin: function(record) {
        var me = this,
            ...
            route = '#EntryPanel/edit' + queryString,
            name  = 'entryPopupWin';
        if(Ext.isEmpty(me.entryPanelWin)){
            route = 'popupWindow#EntryPanel/edit' + queryString;
            ...
            if(!Ext.isEmpty(me.entryPanelWin.YBase)){
                entryPanelCtrl = me.entryPanelWin.YBase.app.getController('EntryPanelController');
    ...
    init: function(application) {
        ...
        me.control({
            ...
            // },
            "order button[itemId=btnNewEntry]" : {
                click:me.onBtnNewEntryClick
            },
            "order button[itemId=btnCsvImport]" : {
                click:me.onBtnCsvImportClick
            },
            "order button[itemId=btnEditPopupEntry]" : {
                click : me.onBtnEditPopupEntryClick
            },
            "order menuitem[itemId=monthlySalesPrintMenu]":{
                click : me.onMonthlySalesPrintMenuClick
            },
            "order menuitem[itemId=orderContractPrintMenu]":{
                click : me.onOrderContractPrintMenuClick
            },
            "order menuitem[itemId=menuItemServiceInvoice]":{
