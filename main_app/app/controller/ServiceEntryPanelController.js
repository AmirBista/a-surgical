Ext.define('YBase.controller.ServiceEntryPanelController', {
    extend: 'YBase.controller.EntryPanelBaseController', 
    pnlName : 'ServiceEntryPanel',
    pnlNo : 10,
    currentViewAlias: 'serviceEntryPanel',
    is_bill_order : 1,
    absCmp:null,
    msgCmp: null,
    ...
    saveRecord: function(button,showMsgAfterSave,actionType){
        ...
        if(true){
            ...
            params['time_zone'] = user_tz;
            if(frm.isValid()){
                Ext.msk = Ext.create('YBase.utility.Mask',{hideOnErrorInterval: 30000});
    ...
    init: function(application) {
        ...
        me.control({
          /*  "entryPanel button[itemId=btnFilePopup]":{
            ...
            "serviceEntryPanel button[itemId=btnAddComment]":{
                click:me.onBtnAddCommentClick
            },
            "serviceEntryPanel button[itemId=btnNewOrderEntry]" : {
